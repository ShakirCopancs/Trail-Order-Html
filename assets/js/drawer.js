let drawer = function () {
	...
	let openDrawer = function (trigger) {
		if (trigger.classList.contains("submenu")) {
			// Get submenu content element based on data attribute
			let submenuContent = document.getElementById(trigger.dataset.submenuContent);

			// Update drawer content with submenu content
			let drawerContent = document.getElementById("original-drawer-content");
			drawerContent.innerHTML = submenuContent.innerHTML;
		} else {
			// Find target
